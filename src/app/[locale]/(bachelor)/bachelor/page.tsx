...
import BachelorAddedProgram from "./components/BachelorAddedProgram";
import BachelorWhereToStudy from "./components/BachelorWhereToStudy";
import BachelorArticlesAndGuides from "./components/BachelorArticleGuide";
import BachelorDiscoverProgram from "./components/BachelorDiscoverProgram";
...
export default function Home() {
  ...
  return (
    <div>
      ...
      />
      <EducationJourney />
      <BachelorDiscoverProgram programs={programsData} />
      <BachelorWhereToStudy locations={mockLocations} />
      <BachelorArticlesAndGuides articles={mockArticles} />
      <BachelorAddedProgram programs={mockPrograms} />
    </div>
  );
}
