...
import MbaWhereToStudy from "./components/MbaWhereToStudy";
import MbaArticlesAndGuides from "./components/MbarArticleGuide";
import MbaDiscoverProgram from "./components/MbadiscoverProgram";
import { useTranslations } from "next-intl";

export default function Home() {
  const t = useTranslations("mbaPage");
  ...
  return (
    <div>
      ...
      />
      <EducationJourney />
      <MbaDiscoverProgram programs={programsData} />
      <MbaWhereToStudy locations={mockLocations} />
      <MbaArticlesAndGuides articles={mockArticles} />
