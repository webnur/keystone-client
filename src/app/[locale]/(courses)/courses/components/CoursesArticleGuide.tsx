...
const CoursesArticlesAndGuides: React.FC<MasterArticlesAndGuidesProps> = ({
  articles,
}) => {
    ...
    <section className="bg-gray-100">
      <div className="py-16 container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center mb-4 px-4 md:px-0">
          ...
          <Link href="/courses/courses-articles" className="hidden md:block">
            ...
            >
              ...
              <div className="p-4 flex-grow flex flex-col justify-between">
                ...
                <div className="text-right mt-4">
                  <Link
                    href={`/courses/courses-articles/${article.id}`}
        ...
        <div className="flex justify-center mt-8 md:hidden">
          <Link href="/courses/courses-articles">
...
export default CoursesArticlesAndGuides;
