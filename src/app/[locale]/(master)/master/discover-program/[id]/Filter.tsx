    ...
    <aside className="lg:w-1/4 md:w-2/4 p-4 bg-gray-100 relative">
      ...
      <div
        className={`lg:block md:block ${
          isMobileFilterOpen ? "block fixed inset-0 z-10 bg-gray-100 p-6 overflow-y-auto" : "hidden"
        }`}
      >
        {/* Mobile Close Button */}
        {isMobileFilterOpen && (
          <div className="lg:hidden flex justify-end mb-4">
            <button onClick={() => setIsMobileFilterOpen(false)} className="text-red-500">
              <IoClose size={24} />
            </button>
          </div>
        )}
        ...
        <nav className="mb-4 text-sm">
          <a href="#" className="text-gray-500 hover:underline">Master</a> &gt;{" "}
          <a href="#" className="text-gray-500 hover:underline">Economic Studies</a>
        </nav>
