...
import CoursesAddedProgram from "../components/CoursesAddedProgram";
import CoursePopularFields from "../components/CoursePopularFields";
...
`;
  ...
  return (
    <div>
      <CommonBanner
        title="Courses Degree common banner"
        backgroundImage={
      ...
      <CoursesAddedProgram programs={mockPrograms} />
