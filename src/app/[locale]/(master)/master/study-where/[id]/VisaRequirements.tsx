...
const VisaRequirements: React.FC = () => {
  return (
    <section className="py-6 md:py-16 bg-white container mx-auto lg:ml-12 text-sm md:text-base shadow-md px-4 md:px-0 rounded-sm">
      <h2 className="md:text-3xl text-2xl font-bold md:mb-8 mb-6 text-left">Visa Requirements</h2>
      ...
      <div className="flex flex-col gap-6 md:gap-8">
        ...
        <div className="">
          ...
          <p className="text-gray-700">
            ...
            <a href="https://auswaertiges-amt.de" className="text-blue-600">
        ...
        <div className="">
          ...
          <ul className="list-disc pl-6 text-gray-700">
            ...
            <li>Certificate showing youve purchased health insurance</li>
        ...
        <div className="">
          <h3 className="md:text-lg text-base font-semibold mb-2">Processing time</h3>
          <p className="text-gray-700">8 Weeks</p>
        </div>
        <div className="">
          <h3 className="md:text-lg text-base font-semibold mb-2">Work opportunities</h3>
          <p className="text-gray-700">
