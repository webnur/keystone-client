...
const PopularFields: React.FC = () => {
  return (
    <section className="py-16 bg-gray-900 text-white w-full mx-auto">
      <h2 className="text-3xl font-bold mb-8 text-left w-11/12 mx-auto">Most Popular Fields</h2>
      <div className="flex flex-col gap-10 w-11/12 mx-auto">
        {Object.entries(subjectsData).map(([key, subject], index) => (
          <div key={index} className="mb-6">
            <h3 className="text-xl font-semibold mb-4 text-left">{subject.name}</h3>
