    ...
    <section className="py-12 bg-gray-100">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-6 space-y-4 md:space-y-0 md:space-x-4">
          <h2 className="text-[1.4rem] md:text-3xl font-bold text-left md:text-left">
            {t("discoverTitle")}
          </h2>
          {/* Desktop Discover Button - only visible when showAll is true */}
          {showDiscoverButton && (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 md:gap-4 gap-0">
        ...
        {/* View More Disciplines button */}
        {programs.length > 6 && !showAll && (
        ...
        {/* Mobile Discover All Programs button - only visible when showAll is true */}
        {showDiscoverButton && (
