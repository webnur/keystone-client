...
const BachelorDiscoverProgram: React.FC<DiscoverProgramProps> = ({
  programs,
}) => {
            ...
            >
              ...
              <div className="absolute inset-0 bg-foreground text-white opacity-0 hover:opacity-100 transition-opacity duration-300 flex flex-col justify-between p-4">
                ...
                <div className="flex justify-center items-center w-full mx-auto">
                  <Link
                    href={`/bachelor/discover-program/${program.id}`} // Dynamic routing with program ID
...
export default BachelorDiscoverProgram;
