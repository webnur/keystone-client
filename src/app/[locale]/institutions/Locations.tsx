...
const locations = [
  {
    name: 'Paraquita Bay',
    address: 'CCFC + GQR Paraquita Bay, British Virgin Islands, VG1110, Paraquita Bay',
    socialLinks: {
      facebook: '#',
      instagram: '#',
      linkedin: '#',
          ...
          {locations.map((location, index) => (
            <div key={index} className="bg-white shadow-md p-6 rounded-lg">
              ...
              <div className="flex space-x-4">
                <a href={location.socialLinks.facebook} target="_blank" rel="noopener noreferrer">
                  <i className="fab fa-facebook-f text-red-500"></i>
                </a>
                <a href={location.socialLinks.instagram} target="_blank" rel="noopener noreferrer">
                  <i className="fab fa-instagram text-red-500"></i>
                </a>
                <a href={location.socialLinks.linkedin} target="_blank" rel="noopener noreferrer">
                  <i className="fab fa-linkedin-in text-red-500"></i>
                </a>
                <a href={location.socialLinks.twitter} target="_blank" rel="noopener noreferrer">
                  <i className="fab fa-twitter text-red-500"></i>
                </a>
                <a href={location.socialLinks.youtube} target="_blank" rel="noopener noreferrer">
