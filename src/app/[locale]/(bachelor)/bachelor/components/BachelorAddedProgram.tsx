...
const BachelorAddedProgram: React.FC<NewlyAddedProgramsProps> = ({ programs }) => {
          ...
          {programData.slice(currentIndex, currentIndex + programsToShow).map((program, index) => (
            ...
            >
              ...
              <div className="flex justify-end">
                <Link href={`/bachelor/newly-added-program/${program.id}`}>
...
export default BachelorAddedProgram;
