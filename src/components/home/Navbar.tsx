    ...
    <div className="w-full md:w-[90%] mx-auto flex justify-between items-center py-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex gap-2 ml-6">
          <Button
            text="Sign in"
            className="bg-red-100 text-red-500 hover:text-red-100 font-semibold hover:bg-red-700 border-none px-4 py-2 rounded-md"
          />
          <Button
            text="Register"
            className="bg-red-100 text-red-500 hover:text-red-100 font-semibold hover:bg-red-700 px-4 py-2 rounded-md"
          />
        </div>
      </div>
