...
import OnlineArticlesAndGuides from "./components/OnlineArticleGuide";
import OnlineDiscoverProgram from "./components/OnlineDiscoverProggram";
...
export default function Home() {
  ...
  return (
    <div>
      ...
      />
      <EducationJourney />
      <OnlineDiscoverProgram programs={programsData} />
      <OnlineWhereToStudy locations={mockLocations} />
      <OnlineArticlesAndGuides articles={mockArticles} />
      <OnlineAddedProgram programs={mockPrograms} />
    </div>
  );
}
