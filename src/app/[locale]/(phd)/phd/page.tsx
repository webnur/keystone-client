...
import PhdAddedProgram from "./components/PhdAddedProgram";
...
export default function Home() {
  ...
  return (
    <div>
      ...
      />
      <EducationJourney />
      <PhdDiscoverProgram programs={programsData} />
      <PhdWhereToStudy locations={mockLocations} />
      <PhdArticlesAndGuides articles={mockArticles} />
      <PhdAddedProgram programs={mockPrograms} />
    </div>
  );
}
