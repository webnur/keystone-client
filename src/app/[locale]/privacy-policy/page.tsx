...
const PrivacyPolicyPage = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <h2 className="text-2xl font-bold mb-2">2. ABOUT THE PRIVACY POLICY</h2>
      <p className="mb-4">
        This privacy policy applies for processing of personal data when we process personal data in the capacity of data controller, for instance related to personal data about prospective students, visitors of our websites, and contact information of contact persons at education providers.
      </p>

      <p className="mb-4">
        This privacy policy does not cover instances where we act as a data processor, processing personal data on behalf of an education provider, or when the education provider itself acts as a controller for the relevant processing of personal data. This is the case when the relevant education provider communicates with prospective students, enrolls them into programs, courses, or activities, or otherwise manages and stores their data using our CRM platform after we have facilitated the initial connection. In these situations, the respective education provider is the independent data controller, and we advise you to read the privacy policy of the respective education provider for details on their processing of personal data.
      </p>

      <h2 className="text-2xl font-bold mb-2">3. WHO WE PROCESS PERSONAL DATA ABOUT</h2>
      <p className="mb-4">
        The privacy policy governs the processing of personal data for the following persons:
      </p>
      <ul className="list-disc ml-6 mb-4">
        <li>Prospective students and others submitting personal information through lead forms or by registering a user account</li>
        <li>Prospective students and others who send inquiries directly to us via our website's contact form or via e-mail</li>
        <li>Education provider representatives</li>
        <li>Visitors to our websites</li>
      </ul>

      <h2 className="text-2xl font-bold mb-2">4. PURPOSE, CATEGORIES OF PERSONAL DATA, LEGAL BASIS, AND RETENTION PERIOD</h2>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mb-2">4.1 Processing of personal data relating to student information request forms</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mb-2">4.2 Processing of personal data relating to user accounts</h3>
      <p className="mb-4">
      ...
      {/* Add more sections as needed following this structure */}
      
      <h2 className="text-2xl font-bold mb-2">5. RECIPIENTS OF YOUR PERSONAL DATA</h2>
      <p className="mb-4">
      ...
      {/* Continue rendering the remaining sections in a similar manner */}
    </div>
  );
};
