...
const SubHeaderNav: React.FC<SubHeaderNavProps> = ({
  ...
  return (
    <div className="subheader-container">
      ...
      <nav className="flex justify-left md:py-3 py-1 text-sm md:text-base border-b border-gray-200 container mx-auto overflow-x-auto whitespace-nowrap scroll-smooth" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
        <Link
          href="/master"
          className={` py-2 ${
      ...
      <div className="bg-foreground">
        <div className="container mx-auto subnav w-full py-2 text-sm md:text-base md:py-3 overflow-x-auto whitespace-nowrap scroll-smooth" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
