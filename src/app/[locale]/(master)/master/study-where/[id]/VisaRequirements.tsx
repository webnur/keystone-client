    ...
    <section className="py-16 bg-white container mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-700">
          The perfect option for those that want to learn the German language in Germany.
        </p>
      </div>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-700">
          If you want to study in Germany but are still trying to find the right program or you still haven’t got the confirmation letter from your University.
        </p>
      </div>
      ...
      <div className="mb-8">
        <h3 className="text-xl font-bold mb-4">What type of Visa do you need?</h3>
        <p className="text-gray-700">
          <strong>Visa name:</strong> Language Course Visa; Student Applicant Visa; Student Visa
        </p>
        <p className="text-gray-700">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-700">
          If staying less than 90 days in Germany, citizens from certain countries can enter Germany without a visa. These countries include Venezuela, Vatican City, Uruguay, Singapore, Seychelles, and many more.
        </p>
        <p className="text-gray-700">
          Visit the website of the German Federal Foreign Office for the latest visa requirements for all countries: <a href="https://auswaertiges-amt.de" className="text-blue-600">Visa information - Federal Foreign Office</a>.
        </p>
      </div>

      <div className="mb-8">
        <h3 className="text-xl font-bold mb-4">Where can you make the application?</h3>
        <p className="text-gray-700">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-700">
          First, you need to schedule an appointment for a visa interview. On the day of the interview, you should bring the following visa application documents:
        </p>
        <ul className="list-disc pl-6 text-gray-700">
          <li>Completed application form</li>
          <li>Valid passport</li>
          <li>Two photographs</li>
          <li>Letter showing you’ve been accepted by a German university</li>
          <li>Transcript of academic record</li>
          <li>Certificate of German language proficiency or proof that you intend on attending a language course in Germany</li>
          <li>Proof that you have sufficient funds to support yourself while living in Germany (€8,700 per year)</li>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-700">
          Examination of the visa application usually takes about 6 to 8 weeks for a language course. However, if the language course is longer than three months, processing can extend up to 8 to 10 weeks.
        </p>
        <p className="text-gray-700">
          You should apply as soon as possible, and at least three months before your move to the country.
        </p>
      </div>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-700">
          Citizens of EU/EEA countries and Switzerland can work freely in Germany but for no more than 20 hours a week during term time. Non-EU/EEA citizens can work up to 120 full or 240 half days a year.
        </p>
      </div>

      <div className="mb-8">
        <h3 className="text-xl font-bold mb-4">Why do you need this type of visa?</h3>
        <p className="text-gray-700">
